        ...
        for coin in sellable_coins:
            if coin.get('currency') != 'KRW':
                ...
                if current_price > avg_price * goodsell_percent:
                    highest_price = pyupbit.get_ohlcv(ticker, interval="minute30", count=144)['high'][0]
                    if current_price < highest_price * aftergoodsell_percent:
                        ...
                        post_message(myToken,"#upbit1", current_price[0]+"coin good sell : " +str(ticker))
        ...
        for coin in sellable_coins:
            if coin.get('currency') != 'KRW':
                ...
                if current_price < avg_price * deadsell_percent:
                    ...
                    post_message(myToken,"#upbit1", current_price[0]+"coin dead sell : " +str(ticker))
