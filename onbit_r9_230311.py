...
buydown_percent = 0.990
aftergoodsell_percent = 0.985 #goodsell각 이후 1.5% 떨어지면 매도


now = datetime.datetime.now()

buy_waitlist1 = [] # Condtion 1 & 11 & 12 ,2,3,4,5&11&12,6,8&9 : OK

buy_waitlist = {} # Condtion + 7 : OK
...
list_10 = [] # 5 min MACD (signal cross) - buy command1
list_11 = [] # day envelope (signal cross)
list_12 = [] # 240min envelope (signal cross)
list_13 = [] # 1min macd (signal cross) - buy command2
